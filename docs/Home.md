...
The package requires Zig 0.16.0 or later, has no external package dependencies, and is released under the MIT License. The current package version is `v0.7.2`; its GitHub release is created from the matching tag.
